...
import { c as createExports } from './chunks/entrypoint_I40pZwUs.mjs';
import { manifest } from './manifest__oVb8poC.mjs';
...
const _page4 = () => import('./pages/admin/manage.astro.mjs');
const _page5 = () => import('./pages/admin.astro.mjs');
const _page6 = () => import('./pages/api/create-blog.astro.mjs');
...
const pageMap = new Map([
    ...
    ["src/pages/admin/manage/index.astro", _page4],
    ["src/pages/admin/index.astro", _page5],
    ["src/pages/api/create-blog.ts", _page6],
...
const _args = {
    "middlewareSecret": "d9e228b8-54f7-436d-ac28-19bc8098d8a5",
