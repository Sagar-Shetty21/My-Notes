...
import { z } from 'zod';
import { r as removeBase, i as isRemotePath, p as prependForwardSlash } from './path_CUwa3hy-.mjs';
import { V as VALID_INPUT_FORMATS } from './consts_BmVDRGlB.mjs';
import { A as AstroError, L as LiveContentConfigError, j as AstroUserError, U as UnknownContentCollectionError, c as createComponent, R as RenderUndefinedEntryError, u as unescapeHTML, a as renderTemplate, k as renderUniqueStylesheet, l as renderScriptElement, n as createHeadAndContent, r as renderComponent } from './astro/server_ixCSCnnp.mjs';
import 'kleur/colors';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_DjcruCuK.mjs');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "PUBLIC_SUPABASE_ANON_KEY": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImRseXJycGp5YXFwY2JjY2p6ZG1xIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTM2MjI4ODgsImV4cCI6MjA2OTE5ODg4OH0.a-DFNSoYR1tUwcaZsfEz9L_i_Ksj4QDBqPBQOLw0QRI", "PUBLIC_SUPABASE_URL": "https://dlyrrpjyaqpcbccjzdmq.supabase.co", "SITE": "https://astro-paper.pages.dev/", "SSR": true};
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_ya0Czccs.mjs').then(n => n._);
